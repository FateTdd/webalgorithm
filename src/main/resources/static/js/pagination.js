;(function(factory) {
    ...
    var Pagination = function(element, options) {
        ...
        this.refreshPagination=function(page,cruPage){
            opts.pageCount =parseInt(page);
            opts.current=parseInt(cruPage);
            this.init();
        }
        ...
        this.filling = function(index) {
                ...
                case 'fixed':
                    ...
                    for (; start <= end; start++) {
                        if (start != current) {
                            ...
                            html += '<li class="active"><span class="' + opts.activeCls + '">' + start + '</span></li>';
                        }
                    }
                    if (opts.coping) {
            ...
            html += opts.jump ? '<input type="text" class="jump-input ' + opts.jumpIptCls + '"><a href="javascript:;" class="jump-btn ' + opts.jumpBtnCls + '">' + opts.jumpBtn + '</a>' : '';
            $obj.empty().html(html);
        }
        ;
